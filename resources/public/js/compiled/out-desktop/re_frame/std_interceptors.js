...
var vec__24773_24776 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_24777 = cljs.core.nth.call(null,vec__24773_24776,(0),null);
var only_after_24778 = cljs.core.nth.call(null,vec__24773_24776,(1),null);
var db_changed_QMARK__24779 = (cljs.core.some_QMARK_.call(null,only_before_24777)) || (cljs.core.some_QMARK_.call(null,only_after_24778));
if(db_changed_QMARK__24779){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for: ",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before: ",only_before_24777);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after : ",only_after_24778);
...
var map__24786 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__24786__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__24786__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__24794 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__24794__$1;
var event = cljs.core.get.call(null,map__24794__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__15014__auto___24797 = arguments.length;
var i__15015__auto___24798 = (0);
while(true){
if((i__15015__auto___24798 < len__15014__auto___24797)){
args__15021__auto__.push((arguments[i__15015__auto___24798]));

var G__24799 = (i__15015__auto___24798 + (1));
i__15015__auto___24798 = G__24799;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__15022__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq24796){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq24796));
});
...
var args__15021__auto__ = [];
var len__15014__auto___24805 = arguments.length;
var i__15015__auto___24806 = (0);
while(true){
if((i__15015__auto___24806 < len__15014__auto___24805)){
args__15021__auto__.push((arguments[i__15015__auto___24806]));

var G__24807 = (i__15015__auto___24806 + (1));
i__15015__auto___24806 = G__24807;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__15022__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__24800_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__24801_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__24801_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq24802){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__24803,G__24804,seq24802__$2);
});
