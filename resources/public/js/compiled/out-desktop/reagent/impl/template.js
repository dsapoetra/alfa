...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__14512__auto__,writer__14513__auto__,opt__14514__auto__){
return cljs.core._write.call(null,writer__14513__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__19780 = o;
(G__19780[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__19781__delegate = function (args){
...
while (G__19782__i < G__19782__a.length) {G__19782__a[G__19782__i] = arguments[G__19782__i + 0]; ++G__19782__i;}
  args = new cljs.core.IndexedSeq(G__19782__a,0);
} 
return G__19781__delegate.call(this,args);};
...
return G__19781__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__13894__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__13894__auto__){
var and__13894__auto____$1 = jsprops.hasOwnProperty("onChange");
if(cljs.core.truth_(and__13894__auto____$1)){
return jsprops.hasOwnProperty("value");
} else {
return and__13894__auto____$1;
}
} else {
return and__13894__auto__;
}
})())){
var v = (jsprops["value"]);
var value = (((v == null))?"":v);
...
var G__19789 = jsprops;
(G__19789["defaultValue"] = value);

(G__19789["onChange"] = ((function (G__19789,v,value,on_change){
return (function (p1__19786_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__19786_SHARP_);
});})(G__19789,v,value,on_change))
);

(G__19789["ref"] = ((function (G__19789,v,value,on_change){
return (function (p1__19787_SHARP_){
return (this$["cljsInputElement"] = p1__19787_SHARP_);
});})(G__19789,v,value,on_change))
);
...
var vec__19796 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__19796,(0),null);
var id = cljs.core.nth.call(null,vec__19796,(1),null);
var class$ = cljs.core.nth.call(null,vec__19796,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___19801 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___19801 == null)){
} else {
var key_19802 = temp__4661__auto___19801;
...
var G__19804 = (new reagent.impl.template.NativeWrapper());
(G__19804["name"] = c);
...
var len__15014__auto___19810 = arguments.length;
var i__15015__auto___19811 = (0);
while(true){
if((i__15015__auto___19811 < len__15014__auto___19810)){
args__15021__auto__.push((arguments[i__15015__auto___19811]));

var G__19812 = (i__15015__auto___19811 + (1));
i__15015__auto___19811 = G__19812;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__15022__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq19808){
var G__19809 = cljs.core.first.call(null,seq19808);
var seq19808__$1 = cljs.core.next.call(null,seq19808);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__19809,seq19808__$1);
});
...
break;
default:
var G__19816 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__19816;
continue;
...
var n__14824__auto___19819 = a.length;
var i_19820 = (0);
while(true){
if((i_19820 < n__14824__auto___19819)){
(a[i_19820] = reagent.impl.template.as_element.call(null,(a[i_19820])));

var G__19821 = (i_19820 + (1));
i_19820 = G__19821;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__14824__auto___19822 = a.length;
var i_19823 = (0);
while(true){
if((i_19823 < n__14824__auto___19822)){
var val_19824 = (a[i_19823]);
if((cljs.core.vector_QMARK_.call(null,val_19824)) && ((reagent.impl.template.key_from_vec.call(null,val_19824) == null))){
(o["no-key"] = true);
} else {
}

(a[i_19823] = reagent.impl.template.as_element.call(null,val_19824));

var G__19825 = (i_19823 + (1));
i_19823 = G__19825;
continue;
} else {
}
...
var ctx = ({});
var vec__19829 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__19829,(0),null);
var derefed = cljs.core.nth.call(null,vec__19829,(1),null);
...
var G__19833 = (cljs.core.count.call(null,argv) - first_child);
switch (G__19833) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__19833){
